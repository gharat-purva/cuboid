  ...
  return (
    <div className="p-4 bg-white rounded-3xl font-serif w-2/3 font-medium mr-6">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center border border-dark-gray rounded-lg p-1">
          <span className="mr-2 text-sm font-normal text-dark-gray">Date reach</span>
          <FontAwesomeIcon icon={faCaretDown} className="text-dark-gray" />
        </div>
      </div>
      <div className="text-center mt-10">
        <FontAwesomeIcon icon={faClipboard} className="text-yellow-500 text-6xl mb-4" />
